 ...
 */
public class GoblinBattleOutput {

	static ArrayList<Player> players = new ArrayList<Player>();
	static ArrayList<Wall> walls = new ArrayList<Wall>();
	static ArrayList<Space> spaces = new ArrayList<Space>();
	//static String fname = "files/goblin7.txt"; //(goblin4 - goblin9 are the combat test data)
	static String fname = "files/goblinfinal.txt"; //ERROR; expect 28944
	static String outfname = "files/recording.txt";
...
Outcome: 54 * 536 = 28944
	...
	public static void main(String[] args) {
		//TESTER
		GoblinBattleOutput gb = new GoblinBattleOutput();
		printMap(); //t0
