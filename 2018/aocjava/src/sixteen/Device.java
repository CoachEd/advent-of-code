...
//HAD HELP FROM PYTHON SOLUTION TO FIGURE OUT ORDERING. Some did it manually.
//NOTE: IN THE CONDITIONAL TESTS, SET THE REGISTERS IN ORDER!!! DO NOT DO THIS:
/*
	public void gtir(int A, int B, int C) {
		//gtir (greater-than immediate/register) sets register C to 1 if value A is greater than register B. Otherwise, register C is set to 0.
		register[C] = 0;  //SHOULD NOT BE DONE FIRST!!! DO IT IN ELSE CLAUSE
		if (A > register[B])
			register[C] = 1;
	}
That will modify register [C] when it shouldn't be modified!!!
 */
public class Device {
