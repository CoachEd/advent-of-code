...
class IntcodeComputer:
    ...
    def __init__(self, prog_str, id):
        ...
        self.output_queue = []
        self.input_queue = []
        self.items = ['hypercube','coin','klein bottle','shell','easter egg','astrolabe','tambourine','dark matter']
        self.commands = ['north',
          'take tambourine',       
          'east',
          'take astrolabe',
        ...
        self.combinations = []
        for w in range(1,8):
          for comb in itertools.combinations([1, 2, 3, 4,5,6,7],w):
        ...
        for combo in combos:
          ...
          for item in self.items:
            nxt_combo_arr.append('drop ' + item)    
          # pick up items for this combination    
          for idx3 in combo:
            nxt_combo_arr.append('take ' + self.items[idx3])
          nxt_combo_arr.append('south')
          self.combinations.append(nxt_combo_arr)
        ...
        if opcode == '99':
            ...
            if len(self.input_queue) == 0:
              ...
              if len(self.commands) > 0:
                ...
                # combination phase
                self.commands = self.combinations.pop(0)
                n = self.commands.pop(0)
              else:
                n = input()
