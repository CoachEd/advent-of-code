...
# output JavaScript arrays for HTML Canvas
print()
print('blue_arr = ' + str(wire1_nodes) + ';')
print()
print('red_arr = ' + str(wire2_nodes) + ';')
print()
print('cross_arr = ' + str(crosses) + ';')
print()
